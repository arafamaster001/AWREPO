  ...
  return (
    ...
    >
      ...
      <div className="Hero_Content h-[80vh] flex flex-col gap-5 justify-center relative z-10 col-span-1 px-[5%] lg:px-0 py-[10%]">
        ...
        >
          Arafa Webs crafts tailored digital solutions that deliver real-world
          business results
        </motion.span>
        ...
        >
          <button
            ...
            className="bg-white text-black px-8 py-2 text-lg rounded-xl font-bold"
          >
            Get Started
          </button>
          <button className="bg-black text-white px-8 py-2 text-lg rounded-xl font-bold border-white/20 border">
            Explore More
          </button>
        </motion.div>
      </div>
