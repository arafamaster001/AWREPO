...
const ServicesSection = () => {
  return (
    <div className="w-full h-auto relative px-[5%] py-[20%] lg:p-[5%]">
      <div className="py-[5%]">
      ...
      <div className="grid lg:grid-cols-3  ">
        <div className="col-span-1 services_cards_1 ">
          ...
          <div className="card_buttons flex gap-3 w-full justify-center">
            <Link className="service_btn border-white/20 border flex items-center bg-black gap-2 z-10" href={"/"}>Details <MdArrowOutward /></Link>
          </div>
